...
const EXTRA_CONFIGS = {
  ...
  "KPI / Measures": {
    title: "KPIs / Measures", subtitle: "Define measurable indicators used across objectives and appraisals.",
    cta: "Add Measure", noun: "Measure", verb: "Add", hideStatus: true, hideSegment: true, hideActive: true, modalWidth: 560,
    cols: [{ key: "name", label: "Measure" }, { key: "perspective", label: "Perspective" }, { key: "unit", label: "Unit" }, { key: "target", label: "Target" }, { key: "description", label: "Description" }],
    fields: [
      { key: "name", label: "Measure Name", placeholder: "Eg. Revenue Growth", full: true },
      ...
      { key: "unit", label: "Unit", type: "select", options: ["%", "GHS", "Count", "Days", "Ratio"], placeholder: "Select unit", optional: true },
      { key: "target", label: "Target", placeholder: "Eg. 12%", optional: true },
      { key: "description", label: "Description", type: "textarea", placeholder: "Enter description", full: true, optional: true },
    ],
  },
  "Performance Ratings": {
    title: "Performance Ratings", subtitle: "The rating scale appraisal scores are mapped to.",
    cta: "Add Rating", noun: "Rating", verb: "Add", hideStatus: true, hideSegment: true, hideActive: true, modalWidth: 560,
    cols: [{ key: "label", label: "Rating" }, { key: "range", label: "Score Range" }, { key: "weight", label: "Multiplier" }, { key: "description", label: "Description" }],
    fields: [
      { key: "label", label: "Rating Label", placeholder: "Eg. Exceeds Expectations", full: true },
      { key: "range", label: "Score Range", placeholder: "Eg. 4.5 – 5.0", optional: true },
      { key: "weight", label: "Multiplier", placeholder: "Eg. 1.2", optional: true },
      { key: "description", label: "Description", type: "textarea", placeholder: "Enter description", full: true, optional: true },
    ],
  },
...
const EXTRA_SEED = {
  ...
  "KPI / Measures": _rows([
    { name: "Revenue Growth", perspective: "Financial", unit: "%", target: "12%", description: "Year-on-year net revenue growth" },
    { name: "Cost-to-Income Ratio", perspective: "Financial", unit: "Ratio", target: "0.45", description: "Operating cost over income" },
    { name: "Customer Satisfaction", perspective: "Customer", unit: "%", target: "90%", description: "CSAT survey score" },
    { name: "Net Promoter Score", perspective: "Customer", unit: "Count", target: "30", description: "Customer NPS" },
    { name: "Process Cycle Time", perspective: "Internal Processes", unit: "Days", target: "3", description: "Average end-to-end process time" },
    { name: "First-Pass Yield", perspective: "Internal Processes", unit: "%", target: "98%", description: "Output passing without rework" },
    { name: "Training Hours", perspective: "Learning & Growth", unit: "Count", target: "40", description: "Training hours per employee/yr" },
    { name: "Employee Engagement", perspective: "Learning & Growth", unit: "%", target: "85%", description: "Engagement survey score" },
    { name: "Attrition Rate", perspective: "Learning & Growth", unit: "%", target: "8%", description: "Voluntary turnover rate" },
    { name: "On-time Delivery", perspective: "Internal Processes", unit: "%", target: "95%", description: "Deliverables met on schedule" },
  ]),
  "Performance Ratings": _rows([
    { label: "Outstanding", range: "4.5 – 5.0", weight: "1.25", description: "Consistently far exceeds expectations" },
    { label: "Exceeds Expectations", range: "3.5 – 4.4", weight: "1.10", description: "Frequently surpasses targets" },
    { label: "Meets Expectations", range: "2.5 – 3.4", weight: "1.00", description: "Reliably achieves agreed targets" },
    { label: "Partially Meets", range: "1.5 – 2.4", weight: "0.85", description: "Meets some but not all targets" },
    { label: "Below Expectations", range: "1.0 – 1.4", weight: "0.70", description: "Falls short; improvement required" },
    { label: "Unsatisfactory", range: "0.0 – 0.9", weight: "0.50", description: "Does not meet minimum standards" },
  ]),
