...
function RoleSelectScreen({ roles = [], initial, onContinue }) {
  ...
  return (
    <div style={{ height: "100%", background: "var(--gray-75)", display: "flex", alignItems: "center", justifyContent: "center", padding: 24, boxSizing: "border-box" }}>
      <div style={{ width: 416, background: "#fff", border: "1px solid var(--border)", borderRadius: "var(--radius-xl)", boxShadow: "var(--shadow-card)", padding: 40, display: "flex", flexDirection: "column", alignItems: "center", gap: 24 }}>
